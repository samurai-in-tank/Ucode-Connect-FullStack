...
class Superhero extends Human{
    fly() {
        ...
        setTimeout(()=> {
            ...
            document.querySelector('img').src = 'assets/images/dancing.jpeg';
        }, 10000);
    }
    fight () {
...
document.querySelector('img').src = 'assets/images/human.jpeg';
...
function hero() {
    if(human.hero === false) {
        if(human.calories > 500) {
            ...
            document.querySelector('#info').innerHTML = "Shazam!";
            document.querySelector('img').src = 'assets/images/transformation.jpeg';
...
function feed() {
    if (superhero.hero === false) {
        if (human.calories < 500) {
            human.feed()
            document.querySelector('img').src = 'assets/images/eating.jpeg'
            disableButtons();
            setTimeout(() => {
                human.calories += 200;
                setCalories(human.calories);
        ...
        if (superhero.calories < 500) {
            superhero.feed()
            document.querySelector('img').src = 'assets/images/eatingSuper.jpeg'
            disableButtons();
            setTimeout(() => {
                superhero.calories += 200;
                setCalories(superhero.calories);
...
function sleep() {
    if (superhero.hero === false) {
        document.querySelector('img').src = 'assets/images/sleeping.jpeg';
        disableButtons();
        human.sleepFor();
        setTimeout(() => {
...
function fly() {
    document.querySelector('img').src = 'assets/images/flying.jpeg';
    superhero.fly();
    disableButtons();
    setTimeout(() => {
        document.querySelector('img').src = 'assets/images/dancing.jpeg'
...
function fight() {
    document.querySelector('img').src = 'assets/images/defeating.jpeg';
    superhero.fight();
    disableButtons();
    setTimeout(() => {
        document.querySelector('img').src = 'assets/images/dancing.jpeg'
...
function setFirstName(name) {
    ...
    if(name === undefined) {
        while(firstName.innerText === "" || firstName.innerText === null) {
            firstName.innerText = prompt("What's the FIRST name of your hero?", "Dance");
...
function setLastName(name) {
    ...
    if(name === undefined) {
        while(lastName.innerText === "" || lastName.innerText === null) {
            lastName.innerText = prompt("What's the LAST name of your hero?", "Monkey");
            let regex = RegExp('^[a-zA-Z]+$');
...
function setAge() {
    ...
    while(age.innerText === "" || age.innerText === null) {
        age.innerText = prompt("What's the age of your hero?", "80");
